...
*Response:* Two covariates that look the most different are low pollution risk and reef exposure (Exposed).
...
*Response:* Distance to mangroves might confound the estimate of the  effect of MPAs on fish biomass, since farther distances might implicate less food sources and shelter from predators, thus less fish biomass on average. 
...
*Response:* ATT means indicates the average increase in fish biomass in the treated effect.  
...
*Response:* Distance to deep water has the largest SMD after matching. 
...
*Response:* On average, there are approximately 108 kg/ha greater biomass of key fisheries in MPA sites.  

**Q8.** What is the biggest remaining threat to causal interpretation of regression coefficients after matching?

*Response:* The biggest threat to our causal interpretation in this case is that the regression has not accounted fully for unobserved selection bias.
...
*Response:* The coefficient increased 0.126 to 0.227. This change suggests that our time-variant factors confounded the ``vpd` estimates.
...
*Response:* The year fixed effect was included to account for conditions  that could affect all plots in a given year. For example, events like an unusually warm winter could alter the concentration of microorganisms in the water and in turn affect nutrient cycling.  
...
*Response:* `Plot` fixed effects are included to account for `time-invariant` factors that could bias  the treatment effect. One example is the fertility of the soil, which could affect the concentration of nutrients available.  
